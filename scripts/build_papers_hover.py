#!/usr/bin/env python3
"""Build public/data/papers_hover.json — pre-baked hover-card data for the publications
...
PAPERS = os.path.join(ROOT, "public", "data", "papers.json")
OUT = os.path.join(ROOT, "public", "data", "papers_hover.json")
